# kajal - Android WebView APK Project
...
- **Target URL**: https://subs24.blogspot.com
...
1. Create a new GitHub repository (e.g. `https://github.com/your-username/kajal`).
...
5. Download the finished **`kajal-v1.0.0.apk`** from Artifacts.
